...
if (lastIndex !== -1 && !content.includes("import-cornerstone-southern-california-new")) {
    content = content.substring(0, lastIndex) + ',\n' + newAccounts;
    fs.writeFileSync(filePath, content);
    console.log("Appended accounts to the end successfully.");
} else {
    console.log("Already appended or could not find last ];");
}
