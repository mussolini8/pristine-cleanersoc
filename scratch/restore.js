...
const badPart = `schedule_rules?: ImportedCommercialScheduleRule[  { 
    id: "import-13demarzo", 
    name: "13deMarzo", 
    city: "Irvine", 
...
content = content.replace(badPart, "schedule_rules?: ImportedCommercialScheduleRule[];");

fs.writeFileSync(filePath, content);
console.log("Fixed the broken file");
