...
const STAFF_COLUMNS = "id,user_id,name,email,role,display_role,team_scope,status,hourly_rate,payment_mode,commercial_payroll_eligible,active,interviewed,notes,deleted_at,created_at,updated_at";
