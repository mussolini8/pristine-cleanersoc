        ...
        <Card className="border-border/80">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
              ...
              <label className="space-y-1"><span className="text-xs font-black uppercase text-muted-foreground">Selected date</span><input className="h-10 w-full rounded-md border bg-background px-3 font-bold" type="date" lang="en-US" value={selectedDate} onChange={(event) => setSelectedDate(event.target.value)} /></label>
              <label className="space-y-1"><span className="text-xs font-black uppercase text-muted-foreground">Custom start</span><input className="h-10 w-full rounded-md border bg-background px-3 font-bold" disabled={dateFilterMode !== "custom"} type="date" lang="en-US" value={customStartDate} onChange={(event) => setCustomStartDate(event.target.value)} /></label>
              <label className="space-y-1"><span className="text-xs font-black uppercase text-muted-foreground">Custom end</span><input className="h-10 w-full rounded-md border bg-background px-3 font-bold" disabled={dateFilterMode !== "custom"} type="date" lang="en-US" value={customEndDate} onChange={(event) => setCustomEndDate(event.target.value)} /></label>
